...
`;function ve(i){return Object.keys(i.states).filter(t=>t.startsWith("switch.wateringhub_"))}function U(i,t){return typeof i?.attributes.friendly_name=="string"?i.attributes.friendly_name:t}function fe(i){return i.states["sensor.wateringhub_status"]?.state??"idle"}function st(i){let t=i.states["sensor.wateringhub_status"];if(t?.state!=="error")return null;let e=t.attributes,r=e.current_program,n=r?i.states[`switch.wateringhub_${r}`]:void 0;return{programName:U(n,r??""),errorMessage:e.error_message??""}}function at(i){let t=i.states["sensor.wateringhub_status"];if(t?.state!=="running")return null;let e=t.attributes,r=e.valves_done??0,n=e.valves_total??1,o=Array.isArray(e.valves_sequence)?e.valves_sequence:[],s=Array.isArray(e.active_valves)?e.active_valves:[],d=s.map(v=>{let S=Math.max(0,(Date.now()-new Date(v.valve_start).getTime())/1e3),Q=Math.max(0,v.valve_duration-S),b=o.filter(x=>x.water_supply_id===v.water_supply_id&&x.status==="pending").reduce((x,z)=>x+z.duration,0);return Q+b}),a=d.length>0?Math.max(...d):0,p=[...new Set(o.map(v=>v.water_supply_id))].map(v=>o.filter(S=>S.water_supply_id===v).reduce((S,Q)=>S+Q.duration,0)),u=p.length>0?Math.max(...p):0,_=o.filter(v=>v.status==="done").reduce((v,S)=>v+S.duration,0),y=s.reduce((v,S)=>v+Math.max(0,(Date.now()-new Date(S.valve_start).getTime())/1e3),0),f=_+y;return{programName:e.current_program??"",valvesDone:r,valvesTotal:n,progressPercent:e.progress_percent??0,totalRemaining:a,totalDuration:u,totalElapsed:f,valveSequence:o,activeValves:s,dryRun:e.dry_run===!0}}function Me(i){if(i<=0)return"0:00";let t=Math.floor(i/3600),e=Math.floor(i%3600/60),r=Math.floor(i%60);return t>0?`${t}:${e.toString().padStart(2,"0")}:${r.toString().padStart(2,"0")}`:`${e}:${r.toString().padStart(2,"0")}`}function _e(i,t){return i?i.time:""}function lt(i){return!i||i.state==="None"||i.state==="unknown"||i.state==="unavailable"}function Ie(i,t,e,r){let n=i.states[t];if(lt(n))return e("time.never");let o=new Date(n.state);if(Number.isNaN(o.getTime()))return n.state;let s=new Date,d=s.getTime()-o.getTime();if(d<0){let u=new Date(s.getFullYear(),s.getMonth(),s.getDate()),_=new Date(o.getFullYear(),o.getMonth(),o.getDate()),y=Math.round((_.getTime()-u.getTime())/(1e3*60*60*24)),f=o.toLocaleTimeString(r??[],{hour:"2-digit",minute:"2-digit"});return y===0?e("time.today_at",{time:f}):y===1?e("time.tomorrow_at",{time:f}):e("time.in_days",{count:y})}let a=Math.floor(d/(1e3*60));if(a<1)return e("time.just_now");if(a<60)return e("time.minutes_ago",{count:a});let c=Math.floor(a/60);if(c<24)return e("time.hours_ago",{count:c});let p=Math.floor(c/24);return e("time.days_ago",{count:p})}function ct(i,t,e){let r=i.states["sensor.wateringhub_next_run"];return lt(r)?t("time.no_schedule"):Ie(i,"sensor.wateringhub_next_run",t,e)}function dt(i){let t=i.attributes.skip_until;if(typeof t!="string")return null;let e=new Date(t+"T23:59:59");if(Number.isNaN(e.getTime()))return null;let r=new Date;if(r>e)return null;let n=new Date(r.getFullYear(),r.getMonth(),r.getDate()),o=new Date(e.getFullYear(),e.getMonth(),e.getDate());return{isSkipped:!0,daysRemaining:Math.max(1,Math.ceil((o.getTime()-n.getTime())/(1e3*60*60*24))),skipUntil:t}}function pt(i,t){return t("skip.active",{count:i})}function Y(i,t){return l`<span class="badge-sm badge-${i}">${t}</span>`}function ce(i,t,e="primary"){return l`<button class="btn btn-${e}" @click=${t}>${i}</button>`}function W(i,t,e){return l`
  ...
  `}function K(i,t,e,r,n,o){return i?l`
  ...
  `}function Ht(i,t,e,r,n,o,s,d){if(!e)return l`
    ...
    `;if(fe(i)==="running"){let _=i.states["sensor.wateringhub_status"]?.attributes.current_program,y=t.entity_id?.replace("switch.wateringhub_","");return l`
      <div class="program-status">
        ${_===y?Y("running",n("status.running")):m}
      </div>
    `}let c=dt(t),p=r?Bt(s,n):m;return l`
    <div class="program-status">
      ${c?l`
            ${Y("skipped",pt(c.daysRemaining,n))}
  ...
  `:l``}function gt(i,t,e){let r=at(i);if(!r)return l``;let n=i.states["sensor.wateringhub_status"]?.attributes.water_supplies??[],o=r.activeValves.length>1?jt(r.valveSequence,r.activeValves,n):ht(r.valveSequence,r.activeValves),s=r.valveSequence.length>0?o:m,d=2*Math.PI*30,a=r.totalDuration>0?r.totalElapsed/r.totalDuration:0,c=d*(1-Math.min(1,a));return l`
    <div class="running-block">
      <button class="running-stop-btn" @click=${t}>${e("stop_all")}</button>
      ${r.dryRun?Y("dry-run",e("running.dry_run")):m}
  ...
  `}function vt(i,t,e,r,n,o,s,d,a,c){return t.length===0?l`<div class="empty-state">${c("no_programs")}</div>`:l`${t.map(p=>{let u=i.states[p];if(!u)return m;let _=u.state==="on",y=e===p,f=U(u,p);return l`
      <div class="program-wrapper">
        ...
        ${Ht(i,u,_,r===p,c,()=>s(p),v=>d(p,v),()=>a(p))}
  ...
  `}function Wt(i,t){return i?i.type==="every_n_days"?` \xB7 ${t("recap.frequency_every_n",{n:i.n??2})}`:i.type==="weekdays"&&i.days?.length?` \xB7 ${i.days.map(r=>t(`days.${r}`)).join(", ")}`:"":""}var H=class extends A{constructor(){super(...arguments);this._t=e=>e}set hass(e){this._hass=e,this._t=N(e.language)}setConfig(e){this._config=e}_titleChanged(e){let r=e.target.value;this._config={...this._config,title:r},this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config}}))}render(){return l`
    ...
    `}};w.styles=[V,ot],g([h()],w.prototype,"_config",2),g([h()],w.prototype,"_hass",2),g([h()],w.prototype,"_programEntities",2),g([h()],w.prototype,"_expandedProgram",2),g([h()],w.prototype,"_skipDropdownOpen",2),g([h()],w.prototype,"_toast",2),g([h()],w.prototype,"_confirmMessage",2),g([h()],w.prototype,"_confirmLabel",2),g([h()],w.prototype,"_confirmAction",2),g([h()],w.prototype,"_tick",2),w=g([I("wateringhub-card")],w);globalThis.customCards=globalThis.customCards||[];globalThis.customCards.push({type:"wateringhub-card",name:"WateringHub Card",description:"Watering management card for WateringHub"});var ft=P`
  /* Tabs */
  .tabs {
    display: flex;
...
`;function E(i){return i.states["sensor.wateringhub_status"]?.attributes.available_valves??[]}function F(i){return i.states["sensor.wateringhub_status"]?.attributes.zones??[]}function X(i){return i.states["sensor.wateringhub_status"]?.attributes.water_supplies??[]}function _t(i,t){return t.filter(e=>e.zone_id===i)}function ye(i){return i.toLowerCase().normalize("NFD").replaceAll(/[\u0300-\u036f]/g,"").replaceAll(/[^a-z0-9]+/g,"_").replaceAll(/^_|_$/g,"")}function Ne(i,t,e,r){let n=E(i),o=F(i),s=X(i);return n.length===0?l`
            ...
            <div style="flex:1">
              ...
              <div style="display:flex; gap:8px; margin-top:8px; flex-wrap:wrap;">
                <select
                  ...
                  .value=${d.zone_id}
                  @change=${a=>{t(d.entity_id,"zone_id",a.target.value)}}
                >
                ...
                <select
                  ...
                  @change=${a=>{t(d.entity_id,"water_supply_id",a.target.value)}}
                >
                  ${s.map(a=>l`<option value=${a.id}>${a.name}</option>`)}
                </select>
              </div>
            </div>
            ${W("mdi:delete",()=>e(d.entity_id),{title:r("config.delete"),className:"action-btn delete"})}
          </div>
        </div>
      `)}
  `}function Ve(i,t,e,r,n,o,s,d,a){let c=F(i),p=E(i);return l`
  ...
  `}function Yt(i,t,e,r,n){let s=t.filter(d=>d.zone_id===i.id).map(d=>d.name).join(", ")||"\u2014";return J(i.name,s,()=>e(i),()=>r(i.id),n)}function yt(i,t,e,r,n){return l`
  ...
  `}function De(i,t,e,r,n,o,s,d,a){let c=ve(i),p=F(i),u=E(i);return l`
  ...
  `}function Gt(i,t,e,r,n){let o=U(i,t),s=i.attributes.schedule,d=i.attributes.total_duration,a=i.attributes.dry_run===!0,c=_e(s,n),p=d?`${c} \u2014 ${d} min`:c,u=a?l`<span class="badge-dry-run-sm">${n("config.dry_run")}</span>`:m;return J(l`${o} ${u}`,p,()=>e(t),()=>r(t),n)}function bt(i,t,e,r,n,o,s){let d=i.zones.reduce((a,c)=>a+c.valves.reduce((p,u)=>p+(u.duration||0),0),0);return l`
    <div class="inline-form">
      <!-- Name -->
      ...
      <div class="form-row">
        ...
        ${[...i.zones.map(a=>t.find(c=>c.id===a.zone_id)),...t.filter(a=>!i.zones.some(c=>c.zone_id===a.id))].filter(a=>!!a).map(a=>{let c=i.zones.findIndex(f=>f.zone_id===a.id),p=c>=0?i.zones[c]:null,u=!!p,_=f=>{let v=[...i.zones],S=c+f;[v[c],v[S]]=[v[S],v[c]],o({...i,zones:v})},y=u&&i.zones.length>1?l`
                ...
                <div class="zone-header-row">
                  <label class="checkbox-item">
                    <input
                      type="checkbox"
                      .checked=${u}
                      @change=${()=>{let f=u?i.zones.filter(v=>v.zone_id!==a.id):[...i.zones,{zone_id:a.id,valves:_t(a.id,e).map(v=>({valve_id:v.id,duration:10}))}];o({...i,zones:f})}}
                    />
                    <span class="form-zone-name">${a.name}</span>
                  </label>
                  ${y}
                </div>
                ${u&&p?p.valves.map((f,v)=>Jt(f,v,p,a,i,e,o,s)):m}
              </div>
            `})}
      </div>
  ...
  `}function Jt(i,t,e,r,n,o,s,d){let a=o.find(b=>b.id===i.valve_id)?.name??i.valve_id,c=i.frequency,p=c?.type??"",u=new Date().toISOString().slice(0,10),_=t===0,y=t===e.valves.length-1,f=b=>{let x=e.valves.map(T=>T.valve_id===i.valve_id?{...T,...b}:T),z=n.zones.map(T=>T.zone_id===r.id?{...T,valves:x}:T);s({...n,zones:z})},v=b=>{let x=[...e.valves],z=t+b;[x[t],x[z]]=[x[z],x[t]];let T=n.zones.map(ee=>ee.zone_id===r.id?{...ee,valves:x}:ee);s({...n,zones:T})},S=p==="every_n_days"&&c?l`
          <input
            ...
            ${["mon","tue","wed","thu","fri","sat","sun"].map(b=>{let x=c.days?.includes(b)??!1;return l`
                <label class="valve-freq-day">
                  <input
                    type="checkbox"
                    .checked=${x}
                    @change=${()=>{let z=c.days??[],T=x?z.filter(ee=>ee!==b):[...z,b];f({frequency:{...c,days:T}})}}
                  />
                  ${d(`days.${b}`)}
                </label>
              `})}
    ...
    <div class="valve-config-block">
      <div class="valve-duration-row">
        <div class="reorder-btns">
          <button class="reorder-btn" ?disabled=${_} @click=${()=>v(-1)}>
            <ha-icon icon="mdi:chevron-up"></ha-icon>
          </button>
  ...
  `}function Fe(i,t,e,r,n,o,s,d,a){let c=X(i);return l`
    <div class="form-hint">${a("config.hint_water_supplies")}</div>
    ${c.map(p=>t?.id===p.id?xt(t,o,s,d,a):J(p.name,p.id,()=>e(p),()=>r(p.id),a))}
...
`;var k=class extends A{constructor(){super(...arguments);this._adding=!1;this._newEntityId="";this._newZoneId="";this._newWaterSupplyId="";this._confirmMessage="";this._confirmLabel="";this._confirmAction=null;this._t=e=>e}set hass(e){this._hass=e,this._t=N(e.language)}setConfig(e){this._config=e}_getValves(){return this._hass?E(this._hass):[]}async _setValves(e){await this._hass.callService("wateringhub","set_valves",{valves:e})}_requestConfirm(e,r,n){this._confirmMessage=e,this._confirmLabel=r,this._confirmAction=n}_executeConfirm(){this._confirmAction?.(),this._confirmAction=null,this._confirmMessage="",this._confirmLabel=""}_cancelConfirm(){this._confirmAction=null,this._confirmMessage="",this._confirmLabel=""}_deleteValve(e){this._requestConfirm(this._t("config.confirm_delete_valve"),this._t("config.delete"),async()=>{let r=this._getValves().filter(n=>n.entity_id!==e).map(n=>({entity_id:n.entity_id,name:n.name,water_supply_id:n.water_supply_id,zone_id:n.zone_id}));await this._setValves(r)})}_startAdd(){this._adding=!0,this._newEntityId="",this._newZoneId="",this._newWaterSupplyId=""}_onEntityPicked(e){this._newEntityId=e.detail.value}_getFriendlyName(e){let n=this._hass?.states[e]?.attributes.friendly_name;return typeof n=="string"?n:e}async _confirmAdd(){if(!this._newEntityId||!this._newZoneId||!this._newWaterSupplyId)return;let e=this._getFriendlyName(this._newEntityId),r=[...this._getValves().map(n=>({entity_id:n.entity_id,name:n.name,water_supply_id:n.water_supply_id,zone_id:n.zone_id})),{entity_id:this._newEntityId,name:e,water_supply_id:this._newWaterSupplyId,zone_id:this._newZoneId}];await this._setValves(r),this._adding=!1,this._newEntityId="",this._newZoneId="",this._newWaterSupplyId=""}_cancelAdd(){this._adding=!1,this._newEntityId="",this._newZoneId="",this._newWaterSupplyId=""}render(){let e=this._getValves(),r=F(this._hass),n=X(this._hass);return l`
        ...
        ${this._adding?l`
              <div class="add-form">
                ...
                <div class="form-row">
                  ...
                  <select class="form-select" style="width:100%" .value=${this._newZoneId}
                ...
                <div class="form-row">
                  ...
                  <select class="form-select" style="width:100%" .value=${this._newWaterSupplyId}
    ...
    `}};$.styles=[V,ft],g([h()],$.prototype,"_config",2),g([h()],$.prototype,"_hass",2),g([h()],$.prototype,"_activeTab",2),g([h()],$.prototype,"_editingZone",2),g([h()],$.prototype,"_toast",2),g([h()],$.prototype,"_confirmMessage",2),g([h()],$.prototype,"_confirmLabel",2),g([h()],$.prototype,"_confirmAction",2),g([h()],$.prototype,"_editingProgram",2),g([h()],$.prototype,"_editingWaterSupply",2),$=g([I("wateringhub-config-card")],$);globalThis.customCards=globalThis.customCards||[];globalThis.customCards.push({type:"wateringhub-config-card",name:"WateringHub Config Card",description:"Configuration card for WateringHub zones and programs"});
