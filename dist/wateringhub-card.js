...
`;function he(i){return Object.keys(i.states).filter(t=>t.startsWith("switch.wateringhub_"))}function W(i,t){return typeof i?.attributes.friendly_name=="string"?i.attributes.friendly_name:t}function fe(i){return i.states["sensor.wateringhub_status"]?.state??"idle"}function at(i){let t=i.states["sensor.wateringhub_status"];if(t?.state!=="error")return null;let e=t.attributes,r=e.current_program,n=r?i.states[`switch.wateringhub_${r}`]:void 0;return{programName:W(n,r??""),errorMessage:e.error_message??""}}function lt(i){let t=i.states["sensor.wateringhub_status"];if(t?.state!=="running")return null;let e=t.attributes,r=e.valves_done??0,n=e.valves_total??1,o=Array.isArray(e.valves_sequence)?e.valves_sequence:[],s=Array.isArray(e.active_valves)?e.active_valves:[],d=s.map(v=>{let x=Math.max(0,(Date.now()-new Date(v.valve_start).getTime())/1e3),z=Math.max(0,v.valve_duration-x),w=o.filter(b=>b.water_supply_id===v.water_supply_id&&b.status==="pending").reduce((b,P)=>b+P.duration,0);return z+w}),a=d.length>0?Math.max(...d):0,p=[...new Set(o.map(v=>v.water_supply_id))].map(v=>o.filter(x=>x.water_supply_id===v).reduce((x,z)=>x+z.duration,0)),u=p.length>0?Math.max(...p):0,f=o.filter(v=>v.status==="done").reduce((v,x)=>v+x.duration,0),y=s.reduce((v,x)=>v+Math.max(0,(Date.now()-new Date(x.valve_start).getTime())/1e3),0),_=f+y;return{programName:e.current_program??"",valvesDone:r,valvesTotal:n,progressPercent:e.progress_percent??0,totalRemaining:a,totalDuration:u,totalElapsed:_,valveSequence:o,activeValves:s,dryRun:e.dry_run===!0}}function Me(i){if(i<=0)return"0:00";let t=Math.floor(i/3600),e=Math.floor(i%3600/60),r=Math.floor(i%60);return t>0?`${t}:${e.toString().padStart(2,"0")}:${r.toString().padStart(2,"0")}`:`${e}:${r.toString().padStart(2,"0")}`}function _e(i,t){return i?i.time:""}function ct(i){return!i||i.state==="None"||i.state==="unknown"||i.state==="unavailable"}function Ie(i,t,e,r){let n=i.states[t];if(ct(n))return e("time.never");let o=new Date(n.state);if(Number.isNaN(o.getTime()))return n.state;let s=new Date,d=s.getTime()-o.getTime();if(d<0){let u=new Date(s.getFullYear(),s.getMonth(),s.getDate()),f=new Date(o.getFullYear(),o.getMonth(),o.getDate()),y=Math.round((f.getTime()-u.getTime())/(1e3*60*60*24)),_=o.toLocaleTimeString(r??[],{hour:"2-digit",minute:"2-digit"});return y===0?e("time.today_at",{time:_}):y===1?e("time.tomorrow_at",{time:_}):e("time.in_days",{count:y})}let a=Math.floor(d/(1e3*60));if(a<1)return e("time.just_now");if(a<60)return e("time.minutes_ago",{count:a});let c=Math.floor(a/60);if(c<24)return e("time.hours_ago",{count:c});let p=Math.floor(c/24);return e("time.days_ago",{count:p})}function dt(i,t,e){let r=i.states["sensor.wateringhub_next_run"];return ct(r)?t("time.no_schedule"):Ie(i,"sensor.wateringhub_next_run",t,e)}function pt(i){let t=i.attributes.skip_until;if(typeof t!="string")return null;let e=new Date(t+"T23:59:59");if(Number.isNaN(e.getTime()))return null;let r=new Date;if(r>e)return null;let n=new Date(r.getFullYear(),r.getMonth(),r.getDate()),o=new Date(e.getFullYear(),e.getMonth(),e.getDate());return{isSkipped:!0,daysRemaining:Math.max(1,Math.ceil((o.getTime()-n.getTime())/(1e3*60*60*24))),skipUntil:t}}function ut(i,t){return t("skip.active",{count:i})}function J(i,t){return l`<span class="badge-sm badge-${i}">${t}</span>`}function ce(i,t,e="primary"){return l`<button class="btn btn-${e}" @click=${t}>${i}</button>`}function Y(i,t,e){return l`
  ...
  `}function q(i,t){return l`<button class="add-btn" @click=${t}>${i}</button>`}function G(i,t,e){return l`
    <div class="form-actions">
      ${ce(e("config.cancel"),i,"cancel")}
      ${ce(e("config.save"),t,"primary")}
    </div>
  `}function V(i,t){return l`
    <div class="form-row">
  ...
  `}function jt(i,t,e,r,n,o,s,d){if(!e)return l`
    ...
    `;if(fe(i)==="running"){let f=i.states["sensor.wateringhub_status"]?.attributes.current_program,y=t.entity_id?.replace("switch.wateringhub_","");return l`
      <div class="program-status">
        ${f===y?J("running",n("status.running")):m}
      </div>
  ...
  `:l``}function gt(i,t,e){let r=lt(i);if(!r)return l``;let n=i.states["sensor.wateringhub_status"]?.attributes.water_supplies??[],o=r.activeValves.length>1?Bt(r.valveSequence,r.activeValves,n):ht(r.valveSequence,r.activeValves),s=r.valveSequence.length>0?o:m,d=2*Math.PI*30,a=r.totalDuration>0?r.totalElapsed/r.totalDuration:0,c=d*(1-Math.min(1,a));return l`
  ...
  `}function ft(i,t,e,r,n,o,s,d,a,c){return t.length===0?l`<div class="empty-state">${c("no_programs")}</div>`:l`${t.map(p=>{let u=i.states[p];if(!u)return m;let f=u.state==="on",y=e===p,_=W(u,p);return l`
      <div class="program-wrapper">
        <div class="program">
          <div class="program-header" @click=${()=>n(p)}>
            <ha-icon class="chevron ${y?"open":""}" icon="mdi:chevron-down"></ha-icon>
            ${f?l`<div class="active-dot"></div>`:m}
            <span class="program-name ${f?"active":""}">${_}</span>
          </div>
          <ha-switch .checked=${f} @change=${()=>o(p)}></ha-switch>
        </div>
        ${jt(i,u,f,r===p,c,()=>s(p),v=>d(p,v),()=>a(p))}
  ...
  `}function Yt(i,t){return i?i.type==="every_n_days"?` \xB7 ${t("recap.frequency_every_n",{n:i.n??2})}`:i.type==="weekdays"&&i.days?.length?` \xB7 ${i.days.map(r=>t(`days.${r}`)).join(", ")}`:"":""}var j=class extends A{constructor(){super(...arguments);this._t=e=>e}set hass(e){this._hass=e,this._t=N(e.language)}setConfig(e){this._config=e}_titleChanged(e){let r=e.target.value;this._config={...this._config,title:r},this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config}}))}render(){return l`
    ...
    `}};S.styles=[D,st],g([h()],S.prototype,"_config",2),g([h()],S.prototype,"_hass",2),g([h()],S.prototype,"_programEntities",2),g([h()],S.prototype,"_expandedProgram",2),g([h()],S.prototype,"_skipDropdownOpen",2),g([h()],S.prototype,"_toast",2),g([h()],S.prototype,"_confirmMessage",2),g([h()],S.prototype,"_confirmLabel",2),g([h()],S.prototype,"_confirmAction",2),g([h()],S.prototype,"_tick",2),S=g([I("wateringhub-card")],S);globalThis.customCards=globalThis.customCards||[];globalThis.customCards.push({type:"wateringhub-card",name:"WateringHub Card",description:"Watering management card for WateringHub"});var _t=R`
  /* Tabs */
  .tabs {
    display: flex;
...
`;function E(i){return i.states["sensor.wateringhub_status"]?.attributes.available_valves??[]}function F(i){return i.states["sensor.wateringhub_status"]?.attributes.zones??[]}function Q(i){return i.states["sensor.wateringhub_status"]?.attributes.water_supplies??[]}function yt(i,t){return t.filter(e=>e.zone_id===i)}function ye(i){return i.toLowerCase().normalize("NFD").replaceAll(/[\u0300-\u036f]/g,"").replaceAll(/[^a-z0-9]+/g,"_").replaceAll(/^_|_$/g,"")}function Ne(i,t,e,r,n,o,s,d){let a=E(i),c=F(i),p=Q(i),u=c.length>0&&p.length>0;if(a.length===0)return l`
      <div class="form-hint">${d("config.hint_valves")}</div>
      <div class="empty-state">${d("config.no_valves")}</div>
    `;let f=t!==null,y=f?t:a,_=f?t.every(v=>v.zone_id&&v.water_supply_id):!1;return l`
    <div class="form-hint">${d("config.hint_valves")}</div>
        ...
        <div class="list-item">
          <div class="list-item-header">
            <div style="flex:1">
              ...
              ${u?l`<div style="display:flex; gap:8px; margin-top:8px; flex-wrap:wrap;">
                    <div style="flex:1; min-width:120px;">
                      <label class="form-label">${d("config.tab_zones")}</label>
                      <select
                        class="form-select"
                        style="width:100%"
                        .value=${v.zone_id??""}
                        @change=${x=>{f||e();let z=x.target.value,w=(t??be(a)).map(b=>b.entity_id===v.entity_id?{...b,zone_id:z}:b);r(w)}}
                      >
                        <option value="">—</option>
                        ${c.map(x=>l`<option value=${x.id}>${x.name}</option>`)}
                      </select>
                    </div>
                    <div style="flex:1; min-width:120px;">
                      <label class="form-label">${d("config.tab_water_supplies")}</label>
                      <select
                        class="form-select"
                        style="width:100%"
                        .value=${v.water_supply_id??""}
                        @change=${x=>{f||e();let z=x.target.value,w=(t??be(a)).map(b=>b.entity_id===v.entity_id?{...b,water_supply_id:z}:b);r(w)}}
                      >
                        <option value="">—</option>
                        ${p.map(x=>l`<option value=${x.id}>${x.name}</option>`)}
                      </select>
                    </div>
                  </div>`:m}
            </div>
  ...
  `}function be(i){return i.map(t=>({entity_id:t.entity_id,name:t.name,zone_id:t.zone_id??"",water_supply_id:t.water_supply_id??""}))}function De(i,t,e,r,n,o,s,d,a){let c=F(i),p=E(i);return l`
    <div class="form-hint">${a("config.hint_zones")}</div>
    ${c.map(u=>t?.id===u.id?bt(t,o,s,d,a):Jt(u,p,e,r,a))}
    ${t?.isNew?bt(t,o,s,d,a):m}
    ${t?m:q(`+ ${a("config.new_zone")}`,n)}
    ${c.length===0&&!t?l`<div class="empty-state">${a("config.no_zones")}</div>`:m}
  `}function Jt(i,t,e,r,n){let s=t.filter(d=>d.zone_id===i.id).map(d=>d.name).join(", ")||"\u2014";return K(i.name,s,()=>e(i),()=>r(i.id),n)}function bt(i,t,e,r,n){return l`
    <div class="inline-form">
      ${V(n("config.name"),l`<input
          class="form-input"
          .value=${i.name}
  ...
  `}function Gt(i,t,e,r,n){let o=W(i,t),s=i.attributes.schedule,d=i.attributes.total_duration,a=i.attributes.dry_run===!0,c=_e(s,n),p=d?`${c} \u2014 ${d} min`:c,u=a?l`<span class="badge-dry-run-sm">${n("config.dry_run")}</span>`:m;return K(l`${o} ${u}`,p,()=>e(t),()=>r(t),n)}function xt(i,t,e,r,n,o,s){let d=i.zones.reduce((a,c)=>a+c.valves.reduce((p,u)=>p+(u.duration||0),0),0);return l`
    <div class="inline-form">
      ...
      <!-- Schedule — time only -->
      ${V(s("config.trigger_time"),l`<input
          class="form-input"
          type="time"
      ...
      <div class="form-row">
        ...
        ${[...i.zones.map(a=>t.find(c=>c.id===a.zone_id)),...t.filter(a=>!i.zones.some(c=>c.zone_id===a.id))].filter(a=>!!a).map(a=>{let c=i.zones.findIndex(_=>_.zone_id===a.id),p=c>=0?i.zones[c]:null,u=!!p,f=_=>{let v=[...i.zones],x=c+_;[v[c],v[x]]=[v[x],v[c]],o({...i,zones:v})},y=u&&i.zones.length>1?l`
                ...
                <div class="zone-header-row">
                  <label class="checkbox-item">
                    <input
                      type="checkbox"
                      .checked=${u}
                      @change=${()=>{let _=u?i.zones.filter(v=>v.zone_id!==a.id):[...i.zones,{zone_id:a.id,valves:yt(a.id,e).map(v=>({valve_id:v.id,duration:10}))}];o({...i,zones:_})}}
                    />
                    <span class="form-zone-name">${a.name}</span>
                  </label>
                  ${y}
                </div>
                ${u&&p?p.valves.map((_,v)=>Kt(_,v,p,a,i,e,o,s)):m}
              </div>
            `})}
      </div>
  ...
  `}function Kt(i,t,e,r,n,o,s,d){let a=o.find(w=>w.id===i.valve_id)?.name??i.valve_id,c=i.frequency,p=c?.type??"",u=new Date().toISOString().slice(0,10),f=t===0,y=t===e.valves.length-1,_=w=>{let b=e.valves.map(T=>T.valve_id===i.valve_id?{...T,...w}:T),P=n.zones.map(T=>T.zone_id===r.id?{...T,valves:b}:T);s({...n,zones:P})},v=w=>{let b=[...e.valves],P=t+w;[b[t],b[P]]=[b[P],b[t]];let T=n.zones.map(ee=>ee.zone_id===r.id?{...ee,valves:b}:ee);s({...n,zones:T})},x=p==="every_n_days"&&c?l`
          <input
            class="valve-freq-n-input"
            type="number"
            min="2"
            .value=${String(c.n??2)}
            @input=${w=>_({frequency:{...c,n:Number.parseInt(w.target.value)||2}})}
          />
          <span>j</span>
        `:m,z=p==="weekdays"&&c?l`
          <div class="valve-freq-days">
            ${["mon","tue","wed","thu","fri","sat","sun"].map(w=>{let b=c.days?.includes(w)??!1;return l`
                <label class="valve-freq-day">
                  <input
                    type="checkbox"
                    .checked=${b}
                    @change=${()=>{let P=c.days??[],T=b?P.filter(ee=>ee!==w):[...P,w];_({frequency:{...c,days:T}})}}
                  />
                  ${d(`days.${w}`)}
                </label>
              `})}
    ...
    <div class="valve-config-block">
      <div class="valve-duration-row">
        <div class="reorder-btns">
          <button class="reorder-btn" ?disabled=${f} @click=${()=>v(-1)}>
            <ha-icon icon="mdi:chevron-up"></ha-icon>
          </button>
        ...
        <input
          ...
          @input=${w=>_({duration:Number.parseInt(w.target.value)||1})}
        />
        <span>min</span>
      </div>
      <div class="valve-frequency-row">
        <select
          ...
          .value=${p}
          @change=${w=>{let b=w.target.value;_(b?b==="every_n_days"?{frequency:{type:"every_n_days",n:2,start_date:u}}:{frequency:{type:"weekdays",days:[]}}:{frequency:void 0})}}
        >
  ...
  `}function Fe(i,t,e,r,n,o,s,d,a){let c=Q(i);return l`
    ...
    ${t?m:q(`+ ${a("config.new_water_supply")}`,n)}
...
`;var k=class extends A{constructor(){super(...arguments);this._adding=!1;this._newEntityId="";this._newZoneId="";this._newWaterSupplyId="";this._confirmMessage="";this._confirmLabel="";this._confirmAction=null;this._t=e=>e}set hass(e){this._hass=e,this._t=N(e.language)}setConfig(e){this._config=e}_getValves(){return this._hass?E(this._hass):[]}async _setValves(e){await this._hass.callService("wateringhub","set_valves",{valves:e})}_requestConfirm(e,r,n){this._confirmMessage=e,this._confirmLabel=r,this._confirmAction=n}_executeConfirm(){this._confirmAction?.(),this._confirmAction=null,this._confirmMessage="",this._confirmLabel=""}_cancelConfirm(){this._confirmAction=null,this._confirmMessage="",this._confirmLabel=""}_deleteValve(e){this._requestConfirm(this._t("config.confirm_delete_valve"),this._t("config.delete"),async()=>{let r=this._getValves().filter(n=>n.entity_id!==e).map(n=>({entity_id:n.entity_id,name:n.name,water_supply_id:n.water_supply_id,zone_id:n.zone_id}));await this._setValves(r)})}_startAdd(){this._adding=!0,this._newEntityId="",this._newZoneId="",this._newWaterSupplyId=""}_onEntityPicked(e){this._newEntityId=e.detail.value}_getFriendlyName(e){let n=this._hass?.states[e]?.attributes.friendly_name;return typeof n=="string"?n:e}async _confirmAdd(){if(!this._newEntityId||!this._newZoneId||!this._newWaterSupplyId)return;let e=this._getFriendlyName(this._newEntityId),r=[...this._getValves().map(n=>({entity_id:n.entity_id,name:n.name,water_supply_id:n.water_supply_id,zone_id:n.zone_id})),{entity_id:this._newEntityId,name:e,water_supply_id:this._newWaterSupplyId,zone_id:this._newZoneId}];await this._setValves(r),this._adding=!1,this._newEntityId="",this._newZoneId="",this._newWaterSupplyId=""}_cancelAdd(){this._adding=!1,this._newEntityId="",this._newZoneId="",this._newWaterSupplyId=""}render(){let e=this._getValves(),r=F(this._hass),n=Q(this._hass);return l`
    ...
    `}};$.styles=[D,_t],g([h()],$.prototype,"_config",2),g([h()],$.prototype,"_hass",2),g([h()],$.prototype,"_activeTab",2),g([h()],$.prototype,"_editingZone",2),g([h()],$.prototype,"_toast",2),g([h()],$.prototype,"_confirmMessage",2),g([h()],$.prototype,"_confirmLabel",2),g([h()],$.prototype,"_confirmAction",2),g([h()],$.prototype,"_editingProgram",2),g([h()],$.prototype,"_editingWaterSupply",2),g([h()],$.prototype,"_editingValves",2),$=g([I("wateringhub-config-card")],$);globalThis.customCards=globalThis.customCards||[];globalThis.customCards.push({type:"wateringhub-config-card",name:"WateringHub Config Card",description:"Configuration card for WateringHub zones and programs"});
