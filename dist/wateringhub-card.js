...
`;function Y(r){return r.states["sensor.wateringhub_status"]?.attributes.available_valves??[]}function pe(r){return r.states["sensor.wateringhub_status"]?.attributes.zones??[]}function ue(r){return r.toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g,"").replace(/[^a-z0-9]+/g,"_").replace(/^_|_$/g,"")}function Ye(r,e,t){let n=[{id:"valves",label:t("config.tab_valves")},{id:"zones",label:t("config.tab_zones")},{id:"programs",label:t("config.tab_programs")}];return d`
  ...
  `}function Qe(r,e){let t=Y(r);return t.length===0?d`<div class="empty-state">${e("config.no_valves")}</div>`:d`
    ${t.map(n=>d`
        <div class="list-item">
      ...
      `)}
  `}function We(r,e,t,n,i,o,s,l,a){let c=pe(r),u=Y(r);return d`
  ...
  `}function Xe(r,e,t,n,i,o,s,l,a){let c=G(r),u=pe(r),p=Y(r);return d`
    ${c.map(g=>{let h=r.states[g];if(!h)return m;let _=h.attributes.program_id??"";return e&&e.id===_?Ge(e,u,p,o,s,l,a):wt(h,g,t,n,a)})}
                    ...
                    ${c.valves.map(p=>{let g=t.find(h=>h.id===p.valve_id)?.name??p.valve_id;return d`
                        <div class="valve-duration-row">
                          ...
                          <input
                            ...
                            @input=${h=>{let _=parseInt(h.target.value)||1,et=c.valves.map(S=>S.valve_id===p.valve_id?{...S,duration:_}:S),tt=r.zones.map(S=>S.zone_id===a.id?{...S,valves:et}:S);o({...r,zones:tt})}}
                          />
                          <span>min</span>
                        </div>
                      `})}
  ...
  `}var x=class extends b{constructor(){super(...arguments);this._activeTab="valves";this._editingZone=null;this._editingProgram=null;this._t=t=>t}setConfig(t){this._config=t}set hass(t){this._hass=t,this._t=K(t.language)}getCardSize(){return 5}_setTab(t){this._activeTab=t,this._editingZone=null,this._editingProgram=null}_newZone(){this._editingZone={id:"",name:"",valves:[],isNew:!0}}_editZone(t){this._editingZone={id:t.id,name:t.name,valves:[...t.valves],isNew:!1}}_cancelZone(){this._editingZone=null}_updateZoneForm(t){this._editingZone=t}async _saveZone(t){let n=t.isNew?ue(t.name):t.id,i=t.isNew?"create_zone":"update_zone";await this._hass.callService("wateringhub",i,{id:n,name:t.name,valves:t.valves}),this._editingZone=null}async _deleteZone(t){confirm(this._t("config.confirm_delete_zone"))&&await this._hass.callService("wateringhub","delete_zone",{id:t})}_newProgram(){this._editingProgram={id:"",name:"",schedule:{type:"daily",time:"22:00"},zones:[],isNew:!0}}_editProgram(t){let n=this._hass.states[t];if(!n)return;let i=n.attributes,o=i.program_id??"",s=i.schedule??{type:"daily",time:"22:00"},l=(i.zones??[]).map(a=>({zone_id:a.zone_id,valves:a.valves.map(c=>({valve_id:c.valve_id,duration:c.duration}))}));this._editingProgram={id:o,name:typeof i.friendly_name=="string"?i.friendly_name:o,schedule:s,zones:l,isNew:!1}}_cancelProgram(){this._editingProgram=null}_updateProgramForm(t){this._editingProgram=t}async _saveProgram(t){let n=t.isNew?ue(t.name):t.id,i=t.isNew?"create_program":"update_program";await this._hass.callService("wateringhub",i,{id:n,name:t.name,schedule:t.schedule,zones:t.zones.map(o=>({zone_id:o.zone_id,valves:o.valves.map(s=>({valve_id:s.valve_id,duration:s.duration}))}))}),this._editingProgram=null}async _deleteProgram(t){if(confirm(this._t("config.confirm_delete_program"))){let i=this._hass.states[t]?.attributes.program_id??"";await this._hass.callService("wateringhub","delete_program",{id:i})}}render(){return!this._hass||!this._config?d`<ha-card>${this._t("loading")}</ha-card>`:d`
      <ha-card>
        ${Ye(this._activeTab,t=>this._setTab(t),this._t)}
        ${this._activeTab==="valves"?Qe(this._hass,this._t):""}
        ${this._activeTab==="zones"?We(this._hass,this._editingZone,t=>this._editZone(t),t=>this._deleteZone(t),()=>this._newZone(),t=>this._saveZone(t),()=>this._cancelZone(),t=>this._updateZoneForm(t),this._t):""}
        ${this._activeTab==="programs"?Xe(this._hass,this._editingProgram,t=>this._editProgram(t),t=>this._deleteProgram(t),()=>this._newProgram(),t=>this._saveProgram(t),()=>this._cancelProgram(),t=>this._updateProgramForm(t),this._t):""}
      </ha-card>
    `}};x.styles=Je,v([f()],x.prototype,"_config",2),v([f()],x.prototype,"_hass",2),v([f()],x.prototype,"_activeTab",2),v([f()],x.prototype,"_editingZone",2),v([f()],x.prototype,"_editingProgram",2),x=v([B("wateringhub-config-card")],x);globalThis.customCards=globalThis.customCards||[];globalThis.customCards.push({type:"wateringhub-config-card",name:"WateringHub Config Card",description:"Configuration card for WateringHub zones and programs"});
