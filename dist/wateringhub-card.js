...
`;function ae(o){return Object.keys(o.states).filter(t=>t.startsWith("switch.wateringhub_"))}function I(o,t){return typeof o?.attributes.friendly_name=="string"?o.attributes.friendly_name:t}function le(o){return o.states["sensor.wateringhub_status"]?.state??"idle"}function We(o){let t=o.states["sensor.wateringhub_status"];if(t?.state!=="error")return null;let e=t.attributes,r=e.current_program,i=r?o.states[`switch.wateringhub_${r}`]:void 0;return{programName:I(i,r??""),errorMessage:e.error_message??""}}function et(o){let t=o.states["sensor.wateringhub_status"];if(t?.state!=="running")return null;let e=t.attributes,r=e.valves_done??0,i=e.valves_total??1,n=Array.isArray(e.valves_sequence)?e.valves_sequence:[],s=Array.isArray(e.active_valves)?e.active_valves:[],l=s.map(g=>{let _=Math.max(0,(Date.now()-new Date(g.valve_start).getTime())/1e3),S=Math.max(0,g.valve_duration-_),ge=n.filter(x=>x.water_supply_id===g.water_supply_id&&x.status==="pending").reduce((x,vt)=>x+vt.duration,0);return S+ge}),a=l.length>0?Math.max(...l):0,d=n.reduce((g,_)=>g+_.duration,0),u=n.filter(g=>g.status==="done").reduce((g,_)=>g+_.duration,0),p=s.reduce((g,_)=>g+Math.max(0,(Date.now()-new Date(_.valve_start).getTime())/1e3),0),f=u+p;return{programName:e.current_program??"",valvesDone:r,valvesTotal:i,progressPercent:e.progress_percent??0,totalRemaining:a,totalDuration:d,totalElapsed:f,valveSequence:n,activeValves:s,dryRun:e.dry_run===!0}}function ze(o){if(o<=0)return"0:00";let t=Math.floor(o/3600),e=Math.floor(o%3600/60),r=Math.floor(o%60);return t>0?`${t}:${e.toString().padStart(2,"0")}:${r.toString().padStart(2,"0")}`:`${e}:${r.toString().padStart(2,"0")}`}function ce(o,t){if(!o)return"";let e=[...o.times].sort();if(e.length===0)return"";if(e.length===1)return t("schedule.at_one",{time:e[0]});let r=e[e.length-1],i=e.slice(0,-1).join(", ");return t("schedule.at_many",{rest:i,last:r})}function tt(o){let t=o?.state;return t==null||t==="None"||t==="null"||t==="unknown"||t==="unavailable"}function Ee(o,t,e,r){let i=o.states[t];if(tt(i))return e("time.never");let n=new Date(i.state);if(Number.isNaN(n.getTime()))return i.state;let s=new Date,l=s.getTime()-n.getTime();if(l<0){let p=new Date(s.getFullYear(),s.getMonth(),s.getDate()),f=new Date(n.getFullYear(),n.getMonth(),n.getDate()),g=Math.round((f.getTime()-p.getTime())/(1e3*60*60*24)),_=n.toLocaleTimeString(r??[],{hour:"2-digit",minute:"2-digit"});return g===0?e("time.today_at",{time:_}):g===1?e("time.tomorrow_at",{time:_}):e("time.in_days",{count:g})}let a=Math.floor(l/(1e3*60));if(a<1)return e("time.just_now");if(a<60)return e("time.minutes_ago",{count:a});let d=Math.floor(a/60);if(d<24)return e("time.hours_ago",{count:d});let u=Math.floor(d/24);return e("time.days_ago",{count:u})}function rt(o,t,e){let r=o.states["sensor.wateringhub_next_run"];return tt(r)?t("time.no_schedule"):Ee(o,"sensor.wateringhub_next_run",t,e)}function it(o){let t=o.attributes.skip_until;if(typeof t!="string")return null;let e=new Date(t+"T23:59:59");if(Number.isNaN(e.getTime()))return null;let r=new Date;if(r>e)return null;let i=new Date(r.getFullYear(),r.getMonth(),r.getDate()),n=new Date(e.getFullYear(),e.getMonth(),e.getDate());return{isSkipped:!0,daysRemaining:Math.max(1,Math.ceil((n.getTime()-i.getTime())/(1e3*60*60*24))),skipUntil:t}}function ot(o,t){return t("skip.active",{count:o})}function O(o,t){return c`<span class="badge-sm badge-${o}">${t}</span>`}function Q(o,t,e="primary"){return c`<button class="btn btn-${e}" @click=${t}>${o}</button>`}function L(o,t,e){return c`
  ...
  `}function de(o,t){return c`<button class="add-btn" @click=${t}>${o}</button>`}function pe(o,t,e){return c`
  ...
  `}function Mt(o,t,e,r,i,n,s,l){if(!e)return c`
    ...
    `;if(le(o)==="running"){let f=o.states["sensor.wateringhub_status"]?.attributes.current_program,g=t.entity_id?.replace("switch.wateringhub_","");return c`
  ...
  `}function Ft(o,t){return!o||o.length===0||t&&o.length===t.length?"":` \xB7 ${[...o].sort().join(", ")}`}function It(o,t){return o?o.type==="every_n_days"?` \xB7 ${t("recap.frequency_every_n",{n:o.n??2})}`:o.type==="weekdays"&&o.days?.length?` \xB7 ${o.days.map(r=>t(`days.${r}`)).join(", ")}`:"":""}var D=class extends w{constructor(){super(...arguments);this._t=e=>e}set hass(e){this._hass=e,this._t=E(e.language)}setConfig(e){this._config=e}_titleChanged(e){let r=e.target.value;this._config={...this._config,title:r},this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config}}))}render(){return c`
    ...
    `}};b.styles=[P,Qe],v([h()],b.prototype,"_config",2),v([h()],b.prototype,"_hass",2),v([h()],b.prototype,"_programEntities",2),v([h()],b.prototype,"_expandedProgram",2),v([h()],b.prototype,"_skipDropdownOpen",2),v([h()],b.prototype,"_toast",2),v([h()],b.prototype,"_confirmMessage",2),v([h()],b.prototype,"_confirmLabel",2),v([h()],b.prototype,"_confirmAction",2),v([h()],b.prototype,"_tick",2),b=v([z("wateringhub-card")],b);globalThis.customCards=globalThis.customCards||[];globalThis.customCards.push({type:"wateringhub-card",name:"WateringHub Card",description:"Watering management card for WateringHub"});var pt=k`
  /* Tabs */
  .tabs {
    display: flex;
...
`;function ue(o){return o.map(t=>({entity_id:t.entity_id,name:t.name,zone_id:t.zone_id,water_supply_id:t.water_supply_id}))}function Z(o){return o.states["sensor.wateringhub_status"]?.attributes.available_valves??[]}function me(o){return o.states["sensor.wateringhub_status"]?.attributes.zones??[]}function ut(o){return o.states["sensor.wateringhub_status"]?.attributes.water_supplies??[]}function W(o){return o.toLowerCase().normalize("NFD").replaceAll(/[\u0300-\u036f]/g,"").replaceAll(/[^a-z0-9]+/g,"_").replaceAll(/^_|_$/g,"")}function Re(o,t,e,r,i,n,s,l,a){let d=ae(o),u=me(o),p=Z(o),f=p.some(g=>g.zone_id!==null);return c`
  ...
  `}function Ut(o,t,e,r,i){let n=o.frequency,s=n?.type??"",l=new Date().toISOString().slice(0,10),a=p=>r(ee(e,t,o.valve_id,{frequency:p})),d=s==="every_n_days"&&n?c`
          <input
...
`;var y=class extends w{constructor(){super(...arguments);this._newEntityId="";this._newZoneId="";this._newWaterSupplyId="";this._editingSupply=null;this._editingZone=null;this._expandedZones=new Set;this._toast="";this._sections={supplies:!0,zones:!0,unassigned:!0,addValve:!1};this._confirmMessage="";this._confirmLabel="";this._confirmAction=null;this._t=e=>e}set hass(e){this._hass=e,this._t=E(e.language)}setConfig(e){this._config=e}_toggleSection(e){this._sections={...this._sections,[e]:!this._sections[e]}}_toggleZone(e){let r=new Set(this._expandedZones);r.has(e)?r.delete(e):r.add(e),this._expandedZones=r}_showToast(e){this._toast=e,setTimeout(()=>{this._toast=""},3e3)}_requestConfirm(e,r,i){this._confirmMessage=e,this._confirmLabel=r,this._confirmAction=i}_executeConfirm(){this._confirmAction?.(),this._confirmAction=null,this._confirmMessage="",this._confirmLabel=""}_cancelConfirm(){this._confirmAction=null,this._confirmMessage="",this._confirmLabel=""}_newSupply(){this._editingSupply={id:"",name:"",isNew:!0}}_editSupply(e){this._editingSupply={...e,isNew:!1}}_cancelSupply(){this._editingSupply=null}_updateSupplyForm(e){this._editingSupply=e}async _saveSupply(e){let r=e.isNew?W(e.name):e.id,i=e.isNew?"create_water_supply":"update_water_supply";await this._hass.callService("wateringhub",i,{id:r,name:e.name}),this._editingSupply=null}_deleteSupply(e){this._requestConfirm(this._t("config.confirm_delete_water_supply"),this._t("config.delete"),async()=>{try{await this._hass.callService("wateringhub","delete_water_supply",{id:e})}catch{}})}_newZone(){this._editingZone={id:"",name:"",isNew:!0}}_editZone(e){this._editingZone={id:e.id,name:e.name,isNew:!1}}_cancelZone(){this._editingZone=null}_updateZoneForm(e){this._editingZone=e}async _saveZone(e){let r=e.isNew?W(e.name):e.id,i=e.isNew?"create_zone":"update_zone";await this._hass.callService("wateringhub",i,{id:r,name:e.name}),this._editingZone=null}_deleteZone(e){this._requestConfirm(this._t("config.confirm_delete_zone"),this._t("config.delete"),async()=>{try{await this._hass.callService("wateringhub","delete_zone",{id:e})}catch{}})}async _changeValveAssignment(e,r,i){let n=ue(Z(this._hass)).map(s=>s.entity_id===e?{...s,[r]:i}:s);await this._hass.callService("wateringhub","set_valves",{valves:n}),this._showToast(this._t("config.saved"))}_deleteValve(e){this._requestConfirm(this._t("config.confirm_delete_valve"),this._t("config.delete"),async()=>{let r=ue(Z(this._hass)).filter(i=>i.entity_id!==e).map(i=>({entity_id:i.entity_id,name:i.name,water_supply_id:i.water_supply_id,zone_id:i.zone_id}));await this._hass.callService("wateringhub","set_valves",{valves:r}),this._showToast(this._t("config.deleted"))})}_onEntityPicked(e){this._newEntityId=e.detail.value}_getFriendlyName(e){let i=this._hass?.states[e]?.attributes.friendly_name;return typeof i=="string"?i:e}async _confirmAddValve(){if(!this._newEntityId){this._showToast(this._t("config.add_valve_pick_entity"));return}let e=this._getFriendlyName(this._newEntityId),r=[...Z(this._hass).map(i=>({entity_id:i.entity_id,name:i.name,water_supply_id:i.water_supply_id,zone_id:i.zone_id})),{entity_id:this._newEntityId,name:e,water_supply_id:this._newWaterSupplyId||null,zone_id:this._newZoneId||null}];await this._hass.callService("wateringhub","set_valves",{valves:r}),this._showToast(this._t("config.saved")),this._resetAddValve()}_resetAddValve(){this._newEntityId="",this._newZoneId="",this._newWaterSupplyId="",this._sections={...this._sections,addValve:!1}}render(){if(!this._hass)return c``;let e=ut(this._hass),r=me(this._hass),i=Z(this._hass),n=ue(i),s=n.filter(l=>!l.zone_id);return c`
      <div class="editor-root">
        ${this._renderSection("supplies",this._t("config.editor_section_supplies"),e.length,this._renderSuppliesBody(e))}
        ${this._renderSection("zones",this._t("config.editor_section_zones"),r.length,this._renderZonesBody(r,n,e))}
        ${s.length>0?this._renderSection("unassigned",this._t("config.editor_section_unassigned"),s.length,this._renderUnassignedBody(s,r,e),!0):m}
    ...
    `}_renderZonesBody(e,r,i){return c`
      ...
      ${e.map(n=>this._editingZone?.id===n.id?this._renderNameForm(this._editingZone.name,s=>this._updateZoneForm({...this._editingZone,name:s}),()=>this._saveZone(this._editingZone),()=>this._cancelZone()):this._renderZoneCard(n,r,e,i))}
      ${this._editingZone?.isNew?this._renderNameForm(this._editingZone.name,n=>this._updateZoneForm({...this._editingZone,name:n}),()=>this._saveZone(this._editingZone),()=>this._cancelZone()):m}
      ${this._editingZone?m:de(`+ ${this._t("config.new_zone")}`,()=>this._newZone())}
    `}_renderZoneCard(e,r,i,n){let s=r.filter(a=>a.zone_id===e.id),l=this._expandedZones.has(e.id);return c`
      <div class="zone-card">
        ...
        ${l?c`
              <div class="zone-card-body">
                ${s.length===0?c`<div class="info-sm" style="padding:6px 0;">
                    ...
                    </div>`:s.map(a=>this._renderValveRow(a,i,n,!1))}
              </div>
            `:m}
      </div>
    `}_renderUnassignedBody(e,r,i){return c` ${e.map(n=>this._renderValveRow(n,r,i,!0))} `}_renderValveRow(e,r,i,n){let s=!e.zone_id,l=!e.water_supply_id,a="border-color: var(--error-color);",d=p=>this._changeValveAssignment(e.entity_id,"zone_id",p||null),u=p=>this._changeValveAssignment(e.entity_id,"water_supply_id",p||null);return c`
    ...
    `}};$.styles=[P,pt],v([h()],$.prototype,"_config",2),v([h()],$.prototype,"_hass",2),v([h()],$.prototype,"_toast",2),v([h()],$.prototype,"_confirmMessage",2),v([h()],$.prototype,"_confirmLabel",2),v([h()],$.prototype,"_confirmAction",2),v([h()],$.prototype,"_editingProgram",2),$=v([z("wateringhub-config-card")],$);globalThis.customCards=globalThis.customCards||[];globalThis.customCards.push({type:"wateringhub-config-card",name:"WateringHub Config Card",description:"Configuration card for WateringHub programs"});
