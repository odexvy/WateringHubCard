...
`;function he(i){return Object.keys(i.states).filter(t=>t.startsWith("switch.wateringhub_"))}function W(i,t){return typeof i?.attributes.friendly_name=="string"?i.attributes.friendly_name:t}function fe(i){return i.states["sensor.wateringhub_status"]?.state??"idle"}function at(i){let t=i.states["sensor.wateringhub_status"];if(t?.state!=="error")return null;let e=t.attributes,r=e.current_program,n=r?i.states[`switch.wateringhub_${r}`]:void 0;return{programName:W(n,r??""),errorMessage:e.error_message??""}}function lt(i){let t=i.states["sensor.wateringhub_status"];if(t?.state!=="running")return null;let e=t.attributes,r=e.valves_done??0,n=e.valves_total??1,o=Array.isArray(e.valves_sequence)?e.valves_sequence:[],s=Array.isArray(e.active_valves)?e.active_valves:[],d=s.map(h=>{let v=Math.max(0,(Date.now()-new Date(h.valve_start).getTime())/1e3),_=Math.max(0,h.valve_duration-v),H=o.filter(j=>j.water_supply_id===h.water_supply_id&&j.status==="pending").reduce((j,b)=>j+b.duration,0);return _+H}),a=d.length>0?Math.max(...d):0,c=o.reduce((h,v)=>h+v.duration,0),u=o.filter(h=>h.status==="done").reduce((h,v)=>h+v.duration,0),p=s.reduce((h,v)=>h+Math.max(0,(Date.now()-new Date(v.valve_start).getTime())/1e3),0),g=u+p;return{programName:e.current_program??"",valvesDone:r,valvesTotal:n,progressPercent:e.progress_percent??0,totalRemaining:a,totalDuration:c,totalElapsed:g,valveSequence:o,activeValves:s,dryRun:e.dry_run===!0}}function Me(i){if(i<=0)return"0:00";let t=Math.floor(i/3600),e=Math.floor(i%3600/60),r=Math.floor(i%60);return t>0?`${t}:${e.toString().padStart(2,"0")}:${r.toString().padStart(2,"0")}`:`${e}:${r.toString().padStart(2,"0")}`}function _e(i,t){return i?i.time:""}function ct(i){return!i||i.state==="None"||i.state==="unknown"||i.state==="unavailable"}function Ne(i,t,e,r){let n=i.states[t];if(ct(n))return e("time.never");let o=new Date(n.state);if(Number.isNaN(o.getTime()))return n.state;let s=new Date,d=s.getTime()-o.getTime();if(d<0){let p=new Date(s.getFullYear(),s.getMonth(),s.getDate()),g=new Date(o.getFullYear(),o.getMonth(),o.getDate()),h=Math.round((g.getTime()-p.getTime())/(1e3*60*60*24)),v=o.toLocaleTimeString(r??[],{hour:"2-digit",minute:"2-digit"});return h===0?e("time.today_at",{time:v}):h===1?e("time.tomorrow_at",{time:v}):e("time.in_days",{count:h})}let a=Math.floor(d/(1e3*60));if(a<1)return e("time.just_now");if(a<60)return e("time.minutes_ago",{count:a});let c=Math.floor(a/60);if(c<24)return e("time.hours_ago",{count:c});let u=Math.floor(c/24);return e("time.days_ago",{count:u})}function dt(i,t,e){let r=i.states["sensor.wateringhub_next_run"];return ct(r)?t("time.no_schedule"):Ne(i,"sensor.wateringhub_next_run",t,e)}function pt(i){let t=i.attributes.skip_until;if(typeof t!="string")return null;let e=new Date(t+"T23:59:59");if(Number.isNaN(e.getTime()))return null;let r=new Date;if(r>e)return null;let n=new Date(r.getFullYear(),r.getMonth(),r.getDate()),o=new Date(e.getFullYear(),e.getMonth(),e.getDate());return{isSkipped:!0,daysRemaining:Math.max(1,Math.ceil((o.getTime()-n.getTime())/(1e3*60*60*24))),skipUntil:t}}function ut(i,t){return t("skip.active",{count:i})}function J(i,t){return l`<span class="badge-sm badge-${i}">${t}</span>`}function ce(i,t,e="primary"){return l`<button class="btn btn-${e}" @click=${t}>${i}</button>`}function Y(i,t,e){return l`
    <button
  ...
  `}function jt(i,t,e,r,n,o,s,d){if(!e)return l`
    ...
    `;if(fe(i)==="running"){let g=i.states["sensor.wateringhub_status"]?.attributes.current_program,h=t.entity_id?.replace("switch.wateringhub_","");return l`
  ...
  `}function ft(i,t,e,r,n,o,s,d,a,c){return t.length===0?l`<div class="empty-state">${c("no_programs")}</div>`:l`${t.map(u=>{let p=i.states[u];if(!p)return m;let g=p.state==="on",h=e===u,v=W(p,u);return l`
      <div class="program-wrapper">
        <div class="program">
          ...
          <ha-switch .checked=${g} @change=${()=>o(u)}></ha-switch>
        </div>
        ${jt(i,p,g,r===u,c,()=>s(u),_=>d(u,_),()=>a(u))}
  ...
  `}function Yt(i,t){return i?i.type==="every_n_days"?` \xB7 ${t("recap.frequency_every_n",{n:i.n??2})}`:i.type==="weekdays"&&i.days?.length?` \xB7 ${i.days.map(r=>t(`days.${r}`)).join(", ")}`:"":""}var O=class extends w{constructor(){super(...arguments);this._t=e=>e}set hass(e){this._hass=e,this._t=V(e.language)}setConfig(e){this._config=e}_titleChanged(e){let r=e.target.value;this._config={...this._config,title:r},this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config}}))}render(){return l`
    ...
    `}};$.styles=[M,st],f([y()],$.prototype,"_config",2),f([y()],$.prototype,"_hass",2),f([y()],$.prototype,"_programEntities",2),f([y()],$.prototype,"_expandedProgram",2),f([y()],$.prototype,"_skipDropdownOpen",2),f([y()],$.prototype,"_toast",2),f([y()],$.prototype,"_confirmMessage",2),f([y()],$.prototype,"_confirmLabel",2),f([y()],$.prototype,"_confirmAction",2),f([y()],$.prototype,"_tick",2),$=f([C("wateringhub-card")],$);globalThis.customCards=globalThis.customCards||[];globalThis.customCards.push({type:"wateringhub-card",name:"WateringHub Card",description:"Watering management card for WateringHub"});var _t=z`
  /* Tabs */
  .tabs {
    display: flex;
...
`;function k(i){return i.states["sensor.wateringhub_status"]?.attributes.available_valves??[]}function I(i){return i.states["sensor.wateringhub_status"]?.attributes.zones??[]}function Q(i){return i.states["sensor.wateringhub_status"]?.attributes.water_supplies??[]}function yt(i,t){return t.filter(e=>e.zone_id===i)}function ye(i){return i.toLowerCase().normalize("NFD").replaceAll(/[\u0300-\u036f]/g,"").replaceAll(/[^a-z0-9]+/g,"_").replaceAll(/^_|_$/g,"")}function Ie(i,t,e,r,n,o,s,d){let a=k(i),c=I(i),u=Q(i),p=c.length>0&&u.length>0;if(a.length===0)return l`
      <div class="form-hint">${d("config.hint_valves")}</div>
      <div class="empty-state">${d("config.no_valves")}</div>
    `;let g=t!==null,h=g?t:a,v=g?t.every(_=>_.zone_id&&_.water_supply_id):!1;return l`
    <div class="form-hint">${d("config.hint_valves")}</div>
    ...
    ${h.map(_=>l`
        <div class="list-item">
          <div class="list-item-header">
            <div style="flex:1">
              <div class="list-item-name">${_.name}</div>
              <div class="list-item-sub">${_.entity_id}</div>
              ${p?l`
                    ${Jt(_,c,u,g,t,a,e,r,d)}
                    ${g&&(!_.zone_id||!_.water_supply_id)?l`<div style="color:var(--error-color);font-size:11px;margin-top:4px;">
                          ${d("config.hint_valves_prereq")}
                        </div>`:m}
                  `:m}
            </div>
            ${Y("mdi:delete",()=>s(_.entity_id),{title:d("config.delete"),className:"action-btn delete"})}
          </div>
        </div>
      `)}
    ...
    <div style="display:flex; gap:8px; margin-top:8px; flex-wrap:wrap;">
      <div style="flex:1; min-width:120px;">
        ...
        <select
          class="form-select"
          style="width:100%;${c?p:""}"
          @change=${g=>{r||s();let h=g.target.value,v=(n??be(o)).map(_=>_.entity_id===i.entity_id?{..._,zone_id:h}:_);d(v)}}
        >
      ...
      <div style="flex:1; min-width:120px;">
        ...
        <select
          class="form-select"
          style="width:100%;${u?p:""}"
          @change=${g=>{r||s();let h=g.target.value,v=(n??be(o)).map(_=>_.entity_id===i.entity_id?{..._,water_supply_id:h}:_);d(v)}}
        >
          <option value="" ?selected=${!i.water_supply_id}>—</option>
          ${e.map(g=>l`<option value=${g.id} ?selected=${g.id===i.water_supply_id}>
                ${g.name}
              </option>`)}
        </select>
      </div>
    </div>
  `}function be(i){return i.map(t=>({entity_id:t.entity_id,name:t.name,zone_id:t.zone_id,water_supply_id:t.water_supply_id}))}function De(i,t,e,r,n,o,s,d,a){let c=I(i),u=k(i);return l`
  ...
  `}function qe(i,t,e,r,n,o,s,d,a){let c=he(i),u=I(i),p=k(i),g=p.some(h=>h.zone_id!==null);return l`
    <div class="form-hint">${a("config.hint_programs")}</div>
    ${g?m:l`<div class="empty-state">${a("config.hint_programs_prereq")}</div>`}
    ${c.map(h=>{let v=i.states[h];if(!v)return m;let _=v.attributes.program_id??"";return t?.id===_?xt(t,u,p,o,s,d,a):Kt(v,h,e,r,a)})}
  ...
  `}function Kt(i,t,e,r,n){let o=W(i,t),s=i.attributes.schedule,d=i.attributes.total_duration,a=i.attributes.dry_run===!0,c=_e(s,n),u=d?`${c} \u2014 ${d} min`:c,p=a?l`<span class="badge-dry-run-sm">${n("config.dry_run")}</span>`:m;return K(l`${o} ${p}`,u,()=>e(t),()=>r(t),n)}function xt(i,t,e,r,n,o,s){let d=i.zones.reduce((a,c)=>a+c.valves.reduce((u,p)=>u+(p.duration||0),0),0);return l`
    <div class="inline-form">
      ...
      <!-- Schedule — time only -->
      ${P(s("config.trigger_time"),l`<input
          class="form-input"
          type="time"
      ...
      <div class="form-row">
        ...
        ${[...i.zones.map(a=>t.find(c=>c.id===a.zone_id)),...t.filter(a=>!i.zones.some(c=>c.zone_id===a.id))].filter(a=>!!a).map(a=>{let c=i.zones.findIndex(v=>v.zone_id===a.id),u=c>=0?i.zones[c]:null,p=!!u,g=v=>{let _=[...i.zones],H=c+v;[_[c],_[H]]=[_[H],_[c]],o({...i,zones:_})},h=p&&i.zones.length>1?l`
                ...
                <div class="zone-header-row">
                  <label class="checkbox-item">
                    <input
                      type="checkbox"
                      .checked=${p}
                      @change=${()=>{let v=p?i.zones.filter(_=>_.zone_id!==a.id):[...i.zones,{zone_id:a.id,valves:yt(a.id,e).map(_=>({valve_id:_.id,duration:10}))}];o({...i,zones:v})}}
                    />
                    <span class="form-zone-name">${a.name}</span>
                  </label>
                  ${h}
                </div>
                ${p&&u?u.valves.map((v,_)=>Xt(v,_,u,a,i,e,o,s)):m}
              </div>
            `})}
      </div>
  ...
  `}function Xt(i,t,e,r,n,o,s,d){let a=o.find(b=>b.id===i.valve_id)?.name??i.valve_id,c=i.frequency,u=c?.type??"",p=new Date().toISOString().slice(0,10),g=t===0,h=t===e.valves.length-1,v=b=>{let A=e.valves.map(T=>T.valve_id===i.valve_id?{...T,...b}:T),D=n.zones.map(T=>T.zone_id===r.id?{...T,valves:A}:T);s({...n,zones:D})},_=b=>{let A=[...e.valves],D=t+b;[A[t],A[D]]=[A[D],A[t]];let T=n.zones.map(ee=>ee.zone_id===r.id?{...ee,valves:A}:ee);s({...n,zones:T})},H=u==="every_n_days"&&c?l`
          <input
            class="valve-freq-n-input"
            type="number"
            min="2"
            .value=${String(c.n??2)}
            @input=${b=>v({frequency:{...c,n:Number.parseInt(b.target.value)||2}})}
          />
          <span>j</span>
        `:m,j=u==="weekdays"&&c?l`
            ...
            ${["mon","tue","wed","thu","fri","sat","sun"].map(b=>{let A=c.days?.includes(b)??!1;return l`
                <label class="valve-freq-day">
                  <input
                    type="checkbox"
                    .checked=${A}
                    @change=${()=>{let D=c.days??[],T=A?D.filter(ee=>ee!==b):[...D,b];v({frequency:{...c,days:T}})}}
                  />
                  ${d(`days.${b}`)}
                </label>
              `})}
    ...
    <div class="valve-config-block">
      <div class="valve-duration-row">
        <div class="reorder-btns">
          <button class="reorder-btn" ?disabled=${g} @click=${()=>_(-1)}>
            <ha-icon icon="mdi:chevron-up"></ha-icon>
          </button>
          <button class="reorder-btn" ?disabled=${h} @click=${()=>_(1)}>
            <ha-icon icon="mdi:chevron-down"></ha-icon>
          </button>
        </div>
        <label>${a}</label>
      ...
      <div class="valve-frequency-row">
        <select
          ...
          .value=${u}
          @change=${b=>{let A=b.target.value;v(A?A==="every_n_days"?{frequency:{type:"every_n_days",n:2,start_date:p}}:{frequency:{type:"weekdays",days:[]}}:{frequency:void 0})}}
        >
  ...
  `}function Fe(i,t,e,r,n,o,s,d,a){let c=Q(i),u=k(i);return l`
    <div class="form-hint">${a("config.hint_water_supplies")}</div>
    ${c.map(p=>{if(t?.id===p.id)return $t(t,o,s,d,a);let h=u.filter(v=>v.water_supply_id===p.id).map(v=>v.name).join(", ")||"\u2014";return K(p.name,h,()=>e(p),()=>r(p.id),a)})}
...
`;var S=class extends w{constructor(){super(...arguments);this._adding=!1;this._newEntityId="";this._newZoneId="";this._newWaterSupplyId="";this._confirmMessage="";this._confirmLabel="";this._confirmAction=null;this._t=e=>e}set hass(e){this._hass=e,this._t=V(e.language)}setConfig(e){this._config=e}_getValves(){return this._hass?k(this._hass):[]}async _setValves(e){await this._hass.callService("wateringhub","set_valves",{valves:e})}_requestConfirm(e,r,n){this._confirmMessage=e,this._confirmLabel=r,this._confirmAction=n}_executeConfirm(){this._confirmAction?.(),this._confirmAction=null,this._confirmMessage="",this._confirmLabel=""}_cancelConfirm(){this._confirmAction=null,this._confirmMessage="",this._confirmLabel=""}_deleteValve(e){this._requestConfirm(this._t("config.confirm_delete_valve"),this._t("config.delete"),async()=>{let r=this._getValves().filter(n=>n.entity_id!==e).map(n=>({entity_id:n.entity_id,name:n.name,water_supply_id:n.water_supply_id,zone_id:n.zone_id}));await this._setValves(r)})}_startAdd(){this._adding=!0,this._newEntityId="",this._newZoneId="",this._newWaterSupplyId=""}_onEntityPicked(e){this._newEntityId=e.detail.value}_getFriendlyName(e){let n=this._hass?.states[e]?.attributes.friendly_name;return typeof n=="string"?n:e}async _confirmAdd(){if(!this._newEntityId||!this._newZoneId||!this._newWaterSupplyId)return;let e=this._getFriendlyName(this._newEntityId),r=[...this._getValves().map(n=>({entity_id:n.entity_id,name:n.name,water_supply_id:n.water_supply_id,zone_id:n.zone_id})),{entity_id:this._newEntityId,name:e,water_supply_id:this._newWaterSupplyId,zone_id:this._newZoneId}];await this._setValves(r),this._adding=!1,this._newEntityId="",this._newZoneId="",this._newWaterSupplyId=""}_cancelAdd(){this._adding=!1,this._newEntityId="",this._newZoneId="",this._newWaterSupplyId=""}render(){let e=this._getValves(),r=I(this._hass),n=Q(this._hass);return l`
    ...
    `}};x.styles=[M,_t],f([y()],x.prototype,"_config",2),f([y()],x.prototype,"_hass",2),f([y()],x.prototype,"_activeTab",2),f([y()],x.prototype,"_editingZone",2),f([y()],x.prototype,"_toast",2),f([y()],x.prototype,"_confirmMessage",2),f([y()],x.prototype,"_confirmLabel",2),f([y()],x.prototype,"_confirmAction",2),f([y()],x.prototype,"_editingProgram",2),f([y()],x.prototype,"_editingWaterSupply",2),f([y()],x.prototype,"_editingValves",2),x=f([C("wateringhub-config-card")],x);globalThis.customCards=globalThis.customCards||[];globalThis.customCards.push({type:"wateringhub-config-card",name:"WateringHub Config Card",description:"Configuration card for WateringHub zones and programs"});
