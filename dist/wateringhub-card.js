...
`;function re(o){return Object.keys(o.states).filter(t=>t.startsWith("switch.wateringhub_"))}function Z(o,t){return typeof o?.attributes.friendly_name=="string"?o.attributes.friendly_name:t}function oe(o){return o.states["sensor.wateringhub_status"]?.state??"idle"}function je(o){let t=o.states["sensor.wateringhub_status"];if(t?.state!=="error")return null;let e=t.attributes,r=e.current_program,n=r?o.states[`switch.wateringhub_${r}`]:void 0;return{programName:Z(n,r??""),errorMessage:e.error_message??""}}function Ue(o){let t=o.states["sensor.wateringhub_status"];if(t?.state!=="running")return null;let e=t.attributes,r=e.current_valve_start,n=e.current_valve_duration??0,i=e.valves_done??0,s=e.valves_total??1,l=r?Math.max(0,(Date.now()-new Date(r).getTime())/1e3):0,a=Math.max(0,n-l),p=n>0?Math.min(100,l/n*100):0,m=(i+p/100)/s*100,d=(i+1)/s*100,g=Array.isArray(e.valves_sequence)?e.valves_sequence:[],v=g.filter(x=>x.status==="pending").reduce((x,b)=>x+b.duration,0),_=a+v,ie=g.length>0?g.reduce((x,b)=>x+b.duration,0):n*s,A=g.filter(x=>x.status==="done").reduce((x,b)=>x+b.duration,0)+l;return{programName:e.current_program??"",zoneName:e.current_zone_name??"",valveName:e.current_valve_name??"",valveStart:r??"",valveDuration:n,valvesDone:i,valvesTotal:s,progressPercent:e.progress_percent??0,remaining:a,totalRemaining:_,totalDuration:ie,totalElapsed:A,valvePercent:p,finePercent:m,globalEndPercent:d,valveSequence:g,dryRun:e.dry_run===!0}}function ye(o){if(o<=0)return"0:00";let t=Math.floor(o/3600),e=Math.floor(o%3600/60),r=Math.floor(o%60);return t>0?`${t}:${e.toString().padStart(2,"0")}:${r.toString().padStart(2,"0")}`:`${e}:${r.toString().padStart(2,"0")}`}function ne(o,t){return o?o.time:""}function Be(o){return!o||o.state==="None"||o.state==="unknown"||o.state==="unavailable"}function be(o,t,e,r){let n=o.states[t];if(Be(n))return e("time.never");let i=new Date(n.state);if(Number.isNaN(i.getTime()))return n.state;let s=new Date,l=s.getTime()-i.getTime();if(l<0){let d=new Date(s.getFullYear(),s.getMonth(),s.getDate()),g=new Date(i.getFullYear(),i.getMonth(),i.getDate()),v=Math.round((g.getTime()-d.getTime())/(1e3*60*60*24)),_=i.toLocaleTimeString(r??[],{hour:"2-digit",minute:"2-digit"});return v===0?e("time.today_at",{time:_}):v===1?e("time.tomorrow_at",{time:_}):e("time.in_days",{count:v})}let a=Math.floor(l/(1e3*60));if(a<1)return e("time.just_now");if(a<60)return e("time.minutes_ago",{count:a});let p=Math.floor(a/60);if(p<24)return e("time.hours_ago",{count:p});let m=Math.floor(p/24);return e("time.days_ago",{count:m})}function Je(o,t,e){let r=o.states["sensor.wateringhub_next_run"];return Be(r)?t("time.no_schedule"):be(o,"sensor.wateringhub_next_run",t,e)}function Ge(o){return c`
  ...
  `:c``}function Ye(o,t,e){let r=Ue(o);if(!r)return c``;let n=2*Math.PI*30,i=r.totalDuration>0?r.totalElapsed/r.totalDuration:0,s=n*(1-Math.min(1,i));return c`
    <div class="running-block">
      ...
      ${r.valveSequence.length>0?Tt(r.valveSequence,r.remaining):u}
    </div>
  `}function Tt(o,t){let e=[];for(let l of o){let a=e[e.length-1];a?.zoneName===l.zone_name?a.valves.push(l):e.push({zoneName:l.zone_name,valves:[l]})}let r=c`<svg viewBox="0 0 24 24">
    <path
      fill="currentColor"
    ...
    <div class="valve-timeline">
      ${e.map(l=>c`
          ...
          ${l.valves.map(a=>{let p=Math.ceil(a.duration/60);return c`
              <div class="tl-step tl-${a.status}">
                ...
                <span class="tl-step-time">
                  ${a.status==="running"?ye(t):`${p} min`}
                </span>
              </div>
            `})}
        `)}
    </div>
  `}function Qe(o,t,e,r,n,i){return t.length===0?c`<div class="empty-state">${i("no_programs")}</div>`:c`${t.map(s=>{let l=o.states[s];if(!l)return u;let a=l.state==="on",p=e===s,m=Z(l,s);return c`
      <div class="program-wrapper">
        <div class="program">
          <div class="program-header" @click=${()=>r(s)}>
            <ha-icon class="chevron ${p?"open":""}" icon="mdi:chevron-down"></ha-icon>
...
`;function F(o){return o.states["sensor.wateringhub_status"]?.attributes.available_valves??[]}function xe(o){return o.states["sensor.wateringhub_status"]?.attributes.zones??[]}function $e(o){return o.toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g,"").replace(/[^a-z0-9]+/g,"_").replace(/^_|_$/g,"")}function tt(o,t,e){let r=[{id:"programs",label:e("config.tab_programs")},{id:"zones",label:e("config.tab_zones")},{id:"valves",label:e("config.tab_valves")}];return c`
  ...
  `}function rt(o,t){let e=F(o);return e.length===0?c`<div class="empty-state">${t("config.no_valves")}</div>`:c`
    ${e.map(r=>c`
      ...
      `)}
  `}function ot(o,t,e,r,n,i,s,l,a){let p=xe(o),m=F(o);return c`
    ${p.map(d=>t&&t.id===d.id?We(t,m,i,s,l,a):zt(d,m,e,r,a))}
    ${t?.isNew?We(t,m,i,s,l,a):u}
    ${t?u:c`<button class="add-btn" @click=${n}>+ ${a("config.new_zone")}</button>`}
    ${p.length===0&&!t?c`<div class="empty-state">${a("config.no_zones")}</div>`:u}
          ...
          ${t.map(s=>{let l=o.valves.includes(s.id);return c`
              <label class="checkbox-item">
                <input
                  type="checkbox"
                  .checked=${l}
                  @change=${()=>{let a=l?o.valves.filter(p=>p!==s.id):[...o.valves,s.id];n({...o,valves:a})}}
                />
                ${s.name}
              </label>
            `})}
  ...
  `}function nt(o,t,e,r,n,i,s,l,a){let p=re(o),m=xe(o),d=F(o);return c`
    ${p.map(g=>{let v=o.states[g];if(!v)return u;let _=v.attributes.program_id??"";return t&&t.id===_?et(t,m,d,i,s,l,a):Ct(v,g,e,r,a)})}
    ${t?.isNew?et(t,m,d,i,s,l,a):u}
    ${t?u:c`<button class="add-btn" @click=${n}>+ ${a("config.new_program")}</button>`}
    ${p.length===0&&!t?c`<div class="empty-state">${a("config.no_programs")}</div>`:u}
  `}function Ct(o,t,e,r,n){let i=Z(o,t),s=o.attributes.schedule,l=o.attributes.total_duration,a=o.attributes.dry_run===!0,p=ne(s,n);return c`
    <div class="list-item">
      <div class="list-item-header">
        <div>
  ...
  `}function et(o,t,e,r,n,i,s){let l=o.zones.reduce((a,p)=>a+p.valves.reduce((m,d)=>m+(d.duration||0),0),0);return c`
    <div class="inline-form">
      <!-- Name -->
      <div class="form-row">
      ...
      <div class="form-row">
        ...
        ${t.map(a=>{let p=o.zones.find(d=>d.zone_id===a.id),m=!!p;return c`
            <div class="form-zone-section">
              <label class="checkbox-item">
                <input
                  type="checkbox"
                  .checked=${m}
                  @change=${()=>{let d=m?o.zones.filter(g=>g.zone_id!==a.id):[...o.zones,{zone_id:a.id,valves:a.valves.map(g=>({valve_id:g,duration:10}))}];i({...o,zones:d})}}
                />
                <span class="form-zone-name">${a.name}</span>
              </label>
              ${m&&p?c`
                    ${p.valves.map(d=>{let g=e.find(y=>y.id===d.valve_id)?.name??d.valve_id,v=y=>{let A=p.valves.map(b=>b.valve_id===d.valve_id?{...b,...y}:b),x=o.zones.map(b=>b.zone_id===a.id?{...b,valves:A}:b);i({...o,zones:x})},_=d.frequency?.type??"",ie=new Date().toISOString().slice(0,10);return c`
                          ...
                          <div class="valve-frequency-row">
                            ...
                            >
                              ...
                              <option value="every_n_days">
                                ${s("config.frequency_every_n",{n:d.frequency?.n??2})}
                              </option>
                            ...
                            ${_==="every_n_days"?c`
                                  <input
                                    ...
                                    type="number"
                                    min="2"
                                    .value=${String(d.frequency?.n??2)}
                                    @input=${y=>v({frequency:{...d.frequency,n:parseInt(y.target.value)||2}})}
                                  />
                                  <span>j</span>
                                `:u}
                            ${_==="weekdays"?c`
                                  <div class="valve-freq-days">
                                    ${["mon","tue","wed","thu","fri","sat","sun"].map(y=>{let A=d.frequency?.days?.includes(y)??!1;return c`
                                          <label class="valve-freq-day">
                                            <input
                                              type="checkbox"
                                              .checked=${A}
                                              @change=${()=>{let x=d.frequency?.days??[],b=A?x.filter(st=>st!==y):[...x,y];v({frequency:{...d.frequency,days:b}})}}
                                            />
                                            ${s(`days.${y}`)}
                                          </label>
                                        `})}
